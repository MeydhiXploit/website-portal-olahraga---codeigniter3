        ...
        <select name="player_type" class="form-control">
            ...
            if (empty($data_playerType)) {
                ...
                foreach ($data_playerType as $playerType) {
                    $selectedPlayerType = isset($data_athlete) ? $data_athlete->playerType_id : null;
                    if (($selectedPlayerType !== null && $selectedPlayerType == $playerType->id) || set_value('player_type') == $playerType->id) {
