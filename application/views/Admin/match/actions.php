...
<div class="modal-body">
        ...
        <div class="mb-3 col-md-6">
            ...
            <select class="form-control" name="sport_club_1" id="sport_club_1" <?php echo !empty($id) ? "disabled" : '' ?>>
                ...
                if (empty($data_sportClub)) {
                    ...
                    echo empty(set_value('sport_club_1')) ? "<option value=''>--- Pilih Club Olahraga ---</option>" : '';
        ...
        <div class="mb-3 col-md-6">
            ...
            <select class="form-control" name="sport_club_2" id="sport_club_2" <?php echo !empty($id) ? "disabled" : '' ?>>
                ...
                if (empty($data_sportClub)) {
                    ...
                    echo empty(set_value('sport_club_2')) ? "<option value=''>--- Pilih Club Olahraga ---</option>" : '';
                    foreach ($data_sportClub as $sport) {
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="match_status" id="match_status">
            ...
            echo empty(set_value('match_status')) ? "<option value=''>--- Pilih Match Status ---</option>" : '';
            foreach ($role as $data) {
                if ($data === set_value('match_status') || (isset($data_match) && $data === $data_match->match_status)) {
