...
<div class="modal-body">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="news_tags" id="news_tags" value="<?php echo set_value('news_tags') ? set_value('news_tags') : (isset($data_news) ? $data_news->news_tags : ''); ?>" placeholder="tag1, tag2, tag3">
