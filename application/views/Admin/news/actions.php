...
<div class="modal-body">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="news_tags" id="news_tags" value="<?php echo set_value('news_tags') ? set_value('news_tags') : (isset($data_news) ? $data_news->news_tags : ''); ?>" placeholder="pisahkan tag dengan koma, contoh: sepakbola, transfer">
        <small class="form-text text-muted">Masukkan tag dipisahkan koma, misal: sepakbola, transfer.</small>
        <span class="alert-danger"><?php echo form_error('news_tags'); ?></span>
    </div>
