...
<html lang="en">
   ...
   <link rel="stylesheet" href="<?php echo site_url('vendor/userpage/')?>css/responsive.css">
    ...
    <script type="text/template" id="deactivated-layout-styles">
        header {
     ...
     <!-- Modern Portal CSS Override -->
     <?php
     $dynamic_base = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http") . "://" . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
     ?>
     <link rel="stylesheet" href="<?php echo $dynamic_base; ?>assets/css/modern-portal.css?v=1.2">
    </head>
    <body class="game_info" data-spy="scroll" data-target=".header">
      ...
      <!-- Modern Portal JS Override -->
      <script src="<?php echo $dynamic_base; ?>assets/js/modern-portal.js?v=1.2"></script>
