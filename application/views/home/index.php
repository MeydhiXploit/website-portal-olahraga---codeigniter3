...
<div id="terkini" class="container" style="margin-top: 40px; margin-bottom: 20px;">
        ...
        <div class="col-md-12">
            <div class="match-board">
                <?php if (empty($latest_matches)): ?>
                    <p style="text-align: center; color: var(--text-muted); font-size: 13.5px; margin: 10px 0;">Belum ada jadwal pertandingan dipublikasikan.</p>
                <?php else: ?>
                    <?php foreach ($latest_matches as $match): ?>
                    <div class="match-row">
                        <div class="match-meta">
                            <i class="fa fa-calendar" style="color: var(--primary); margin-right: 5px;"></i>
                            <span><?php echo date('d M Y - H:i', strtotime($match->match_date)); ?> WIB (<?php echo $match->name_league; ?>)</span>
                        </div>
                        <div class="match-teams">
                            <div class="match-team text-right" style="justify-content: flex-end; width: 200px;">
                                <span class="club-name"><?php echo $match->club_1; ?></span>
                                <img src="<?php echo (strpos($match->logo_club_1, 'http') === 0) ? $match->logo_club_1 : base_url('uploads/' . $match->logo_club_1); ?>" onerror="this.src='<?php echo base_url('assets/img/no-image.jpg'); ?>'" alt="" style="height: 30px; width: 30px; object-fit: contain;">
                            </div>
                            <div class="match-score">
                                <?php echo $match->club_1_score; ?> - <?php echo $match->club_2_score; ?>
                            </div>
                            <div class="match-team text-left" style="justify-content: flex-start; width: 200px;">
                                <img src="<?php echo (strpos($match->logo_club_2, 'http') === 0) ? $match->logo_club_2 : base_url('uploads/' . $match->logo_club_2); ?>" onerror="this.src='<?php echo base_url('assets/img/no-image.jpg'); ?>'" alt="" style="height: 30px; width: 30px; object-fit: contain;">
                                <span class="club-name"><?php echo $match->club_2; ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
